            ...
            {activeCameras.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-gray-500 bg-gray-900/50 border border-gray-800 border-dashed rounded-2xl">
                ...
                {activeCameras.map((cam) => (
                  <div key={cam.id} className="relative aspect-video bg-gray-900 border border-gray-700 hover:border-blue-500/50 rounded-xl shadow-lg flex flex-col items-center justify-center text-gray-400 overflow-hidden group transition-colors">
